...
| File | What |
|------|------|
| `bom-jlcpcb.csv` | JLCPCB BOM format (Comment, Designator, Footprint, LCSC Part #) for the **70 SMD parts only**. The LCSC column is empty on purpose: pick "basic" parts in the JLC parts picker (0805 1 % resistors, 1206/1210 X7R/C0G, S1M, 1N4148W, MMBF5457) — no part numbers were invented here. |
...
The ~70 through-hole parts (power devices, electrolytics, socketed op-amps, the
